    ...
    <footer className="bg-stone-950 text-stone-400 py-20 border-t border-stone-800">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-1">
          <h3 className="text-3xl font-serif text-white italic mb-6">{process.env.NAME}</h3>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-[11px] font-light">
            <a href="tel:0333581" className="hover:text-amber-500 text-stone-200 transition-colors">+92 33xxxxxx</a>
        ...
        <div>
          ...
          <div className="flex gap-6 text-[11px] font-light">
            ...
            <a href="https://wa.me/974476" target="_blank" rel="noopener noreferrer" className="hover:text-white underline underline-offset-4 transition-colors">WhatsApp</a>
          </div>
        </div>
      </div>
